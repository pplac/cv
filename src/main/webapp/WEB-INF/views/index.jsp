...
<%--&lt;%&ndash;<%@ taglib uri="http://www.springframework.org/security/tags" prefix="security"%>&ndash;%&gt;--%>
...
<%--                <form method="post" action='<c:url value="/index/${about.id}"/>'>--%>
...
<%--                                class="text-primary">About me</span></div>--%>
<%--                    </div>--%>
...
<%--                            &lt;%&ndash;                            <security:authorize access="hasAnyRole('ADMIN')">&ndash;%&gt;--%>
